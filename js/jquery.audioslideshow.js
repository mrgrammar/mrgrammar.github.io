	...
	$.fn.audioSlideshow = function( options ) {
		...
		return this.each(function () {
			...
			var $that = $(this),
				...
				$dg = $that.find(settings.dgSelector),
			...
			$dg.click(function(event){
			//	document.parent.location.href="https://someonesaid.tv/ssdg.php";
			});
